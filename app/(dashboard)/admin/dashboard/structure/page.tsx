    ...
    <div className="h-full flex flex-col space-y-8 overflow-hidden">
      <div>
        ...
        <div className="mt-3 flex items-center gap-2 px-3 py-2 rounded-lg bg-hosteloom-accent/5 border border-hosteloom-accent/10 w-fit">
          ...
          <p className="text-xs text-hosteloom-muted font-body">Select a <span className="text-hosteloom-heading font-medium">Block</span> → then a <span className="text-hosteloom-heading font-medium">Floor</span> → to add or manage rooms under it.</p>
        </div>
      </div>

      <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-6 overflow-hidden min-h-0 text-hosteloom-heading">
        <BlockList
          blocks={blocks}
