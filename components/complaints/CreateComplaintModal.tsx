...
const inputClass =
  'w-full bg-transparent border border-hosteloom-border rounded-xl py-3 px-4 text-hosteloom-heading placeholder:text-hosteloom-muted focus:outline-none focus:border-hosteloom-accent transition-all font-body text-sm';
        ...
        >
          ...
          >
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-heading font-semibold text-hosteloom-heading text-sm">New Complaint</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                >
                  {CATEGORIES.map((c) => (
                    <option key={c} value={c} className="bg-hosteloom-surface text-hosteloom-heading">{c}</option>
                  ))}
                </select>
              </div>
              ...
              <div className="flex gap-3 justify-end pt-1">
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-5 py-2 text-sm font-heading font-bold bg-hosteloom-accent hover:bg-hosteloom-accent-hover disabled:opacity-40 disabled:cursor-not-allowed text-hosteloom-heading rounded-xl transition-all"
                >
